        ...
        <div class="dash-content">
            <div class="overview">
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        <i class="uil uil-shopping-cart"></i> <!-- Icono para ventas -->
                        <span class="text">Ventas del Día</span>
                        <span class="number">35</span> <!-- Aquí puedes mostrar dinámicamente el número -->
                    </div>

                    <!-- Órdenes pendientes -->
                    <div class="box box2">
                        <i class="uil uil-clock"></i> <!-- Icono para órdenes pendientes -->
                        <span class="text">Órdenes Pendientes</span>
                        <span class="number">8</span> <!-- Aquí puedes mostrar dinámicamente el número -->
                    </div>

                    <!-- Dinero generado en el día -->
                    <div class="box box3">
                        <i class="uil uil-dollar-sign"></i> <!-- Icono para dinero -->
                        <span class="text">Dinero Hecho</span>
                        <span class="number">$2,450.00</span> <!-- Aquí puedes mostrar dinámicamente el monto -->
                    </div>
                </div>
