    ...
    <section class="home">
        <article class="table-widget">
            <div class="caption">
                ...
                <a href="inventario/alta-inventario.php" class="btn btn-primary">
                    agregar
                </a>
            </div>
            <table>
                ...
                <tbody id="team-member-rows">
                    ...
                    while ($row = mysqli_fetch_row($resultado)) {
                        $consulta2 = "SELECT * FROM productos WHERE codigo_id = '$row[0]'";
                        $resultado2 = mysqli_query($conexion, $consulta2);
                        $productos = mysqli_fetch_row($resultado2);
                        ...
                        echo "<td>" .  $row[2]. "</td>";
                        echo "<td><div class='tags'><div class='tag tag--marketing'>" . $row[3] . "</div></div></td>";
                        echo "<td>" . $row[4] . "</td>";
                        echo "<td>";
