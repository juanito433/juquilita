...
<head>
    ...
    <link rel="stylesheet" href="tabla-empleados.css">
...
<body>
    ...
    <section class="home">
                <article class="table-widget">
                    <div class="caption">
                        ...
                        <a href="empleados/alta-empleados.html" class="btn btn-primary">Agregar</a>
                    ...
                    <table>
                        ...
                        <tbody id="team-member-rows">
                            ...
                            while ($row = mysqli_fetch_row($resultado)) {
                                ...
                                echo "<td>" . $row[6] . "</td>";
                                echo "<td>" . $row[7] . "</td>";
                                echo "<td><div class='tags'><div class='tag ";
                                if ($row[8] == "Cajero") {
                                    echo "tag--dev";
                                } elseif ($row[8] == "Bodegero") {
                                    echo "tag--design";
                                } elseif ($row[8] == "Anaquelero") {
                                    echo "tag--marketing";
                                }
                                echo "'>" . $row[8] . "</div></div></td>";
                                echo "<td>";
    ...
    <script src="tabla-empleados.js"></script>
</body>
